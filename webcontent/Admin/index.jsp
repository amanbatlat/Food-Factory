...
<head>
    ...
    <title>Login -Food Factory Admin</title>
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/Admin/image3.png&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Food Factory Admin</h4>
                                    </div>
                                    <form class="user" action="db_login.jsp">
